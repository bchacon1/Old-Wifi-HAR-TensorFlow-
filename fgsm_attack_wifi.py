...
This utility mirrors the PyTorch FGSM tutorial, evaluating a Wifi-based human
activity recognition model under adversarial perturbations.  Default argument
values are provided so the script can run out-of-the-box, avoiding the previous
error that required explicit ``--model`` specification.
"""
